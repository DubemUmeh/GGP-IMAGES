...
const cards = [
  ...
  },
  {
    ...
    title: "Visit Studio",
    description:
      "ZEN Filling Station via Apremdo New Market, off Apllo, Anaji Rd, Takoradi",
  ...
  return (
    <div className="flex h-full flex-col space-y-8">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-1">
        {cards.map(
          ({ icon: Icon, iconBg, iconColor, title, description, action }) => (
            <div
              key={title}
            ...
            >
              ...
              <div>
                <h3 className="mb-1 text-lg font-semibold font-manrope text-card tracking-wider">
                  {title}
                </h3>
                <p className="mb-2 text-popover font-inter tracking-wide">
                  {title === "Visit Studio" ? (
                    <a
                      href={action.href}
                ...
                {action && (
                  <a
                    href={action.href}
                    className="text-sm font-semibold font-inter tracking-widest text-card hover:underline underline-offset-2"
                  >
                    {action.label}
                  </a>
                )}
      ...
      <div className="group relative mt-6 min-h-75 grow cursor-pointer overflow-hidden rounded-3xl border border-border shadow-sm lg:mt-auto">
        ...
        /> */}
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3975.049261898915!2d-1.7769783!3d4.9314148!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfe779ea880bf953%3A0x2cf5d82062b9cb22!2sGGP%20IMAGES!5e0!3m2!1sen!2sgh!4v1786413081825!5m2!1sen!2sgh"
          allowFullScreen
          loading="lazy"
          referrerPolicy="strict-origin-when-cross-origin"
          className="w-full min-h-75 h-full"
        ></iframe>
