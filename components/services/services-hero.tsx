        ...
        <div className="relative w-full p-5 lg:p-0 h-full z-10 grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="max-w-2xl lg:p-10">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 backdrop-blur-sm font-inter">
              ...
              <span className="text-sm tracking-wide font-semibold text-muted-foreground">
                Our Services
              </span>
            </div>
            ...
            <p className="mb-8 max-w-lg text-lg font-inter text-popover">
              From high-end commercial prints to bespoke packaging and event
              branding, we deliver precision and quality that makes your brand
              stand out.
            </p>
            <ArrowCta
              as="link"
              ...
              href="#services"
              className="bg-secondary w-fit hover:bg-secondary/80"
            />
          </div>
