    ...
    <header className="relative bg-brand-tertiary/90 overflow-hidden pb-16 pt-24 md:pb-24 md:pt-32">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-card/30 bg-secondary/10 px-4 py-2 text-sm font-semibold text-card tracking-wide">
          ...
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-popover">
